...
/**
 * A function that handles comparision. Sahil allowed us to use an int for qsort
 *  in stdlib. int64,size_t, and other int alternatives were not working.
*/
 ...
 * 
 * @param list a pointer to a list returned from list_init()
 * @param compare a functions used to compare
*/
void list_sort(list_t *list, __compar_fn_t compare);

/**
 * Clears the list and frees its elements
 * 
 * @param list a pointer to a list returned from list_init()
*/
